...
// Mon Sep  3 14:54:26 2018 by ROOT version 6.12/04
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1478];   //[nhits]
   Int_t           hit_wire[1478];   //[nhits]
   Int_t           hit_channel[1478];   //[nhits]
   Double_t        hit_peakT[1478];   //[nhits]
   Double_t        hit_charge[1478];   //[nhits]
   Double_t        hit_ph[1478];   //[nhits]
   Double_t        hit_tstart[1478];   //[nhits]
   Double_t        hit_tend[1478];   //[nhits]
   Int_t           hit_trkid[1478];   //[nhits]
   Int_t           hit_trkkey[1478];   //[nhits]
   Int_t           hit_clukey[1478];   //[nhits]
   Int_t           hit_pk[1478];   //[nhits]
   Int_t           hit_t[1478];   //[nhits]
   Int_t           hit_ch[1478];   //[nhits]
   Int_t           hit_fwhh[1478];   //[nhits]
   Double_t        hit_rms[1478];   //[nhits]
   Double_t        hit_nelec[1478];   //[nhits]
   Double_t        hit_energy[1478];   //[nhits]
   Float_t         hit_dQds[1478];   //[nhits]
   Float_t         hit_dEds[1478];   //[nhits]
   Float_t         hit_ds[1478];   //[nhits]
   Float_t         hit_resrange[1478];   //[nhits]
   Float_t         hit_x[1478];   //[nhits]
   Float_t         hit_y[1478];   //[nhits]
   Float_t         hit_z[1478];   //[nhits]
   Int_t           nwctrks;
...
#ifdef Sample_cxx
Sample::Sample(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/test.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/test.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/test.root:/anatree");
...
Int_t Sample::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Sample::LoadTree(Long64_t entry)
{
...
void Sample::Show(Long64_t entry)
{
...
Int_t Sample::Cut(Long64_t entry)
{
